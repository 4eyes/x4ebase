...
class featureFamily
{
    ...
    */
    public static function find($obj)
    {
        ...
        } elseif (Detector::$noJSCookieFamilySupport && isset($obj->nojs) && ($obj->nojs == true)) {
            return Detector::$noJSDefaultFamily;
        } elseif (Detector::$noJSCookieFamilySupport && isset($obj->nocookies) && ($obj->nocookies == true)) {
        ...
        } elseif (Detector::$switchFamily && isset($_REQUEST['family']) && ($_REQUEST['family'] == 'clear-family')) {
            unset($_SESSION['detectorFamily']);
        } elseif (isset($_SESSION['detectorFamily'])) {
