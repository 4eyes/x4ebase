...
{
    public static function writeHistoryEntry($tablename, $recuid, $fieldArray = [], $recpid = 0, $userId = 0, $workspaceId = 0)
    {
        /**
     ...
     * @param int $recuid Record UID. Special field used by tce_main.php.
     * @param int $recpid Record PID. Special field used by tce_main.php. OBSOLETE
     ...
     */
    public static function writelog($type, $action, $error, $details_nr, $details, $data, $tablename = '', $recuid = '', $recpid = '', $event_pid = -1, $NEWid = '', $userId = 0, $workspace = 0)
    {
        $fields_values = [
            'userid' => $userId,
            'type' => intval($type),
