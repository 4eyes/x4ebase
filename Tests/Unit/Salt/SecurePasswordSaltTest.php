...
class SecurePasswordSaltTest extends \X4e\X4ebase\Tests\Unit\Base\ModelTestBase
{
    ...
    public function testIsValidSalt()
    {
        ...
        $testCases = [
            ['a', false],
            ['*abcdEFGhijKlmNoP1589452', false],
            ['abcdEFGhijKlmNoP1589452', true]
        ];
        foreach ($testCases as $testCase) {
    ...
    public function testIsValidSaltedPW()
    {
        ...
        $testCases = [
            [password_hash('HelloWorld', PASSWORD_DEFAULT, ['cost' => 11]), false],
            [password_hash('HelloWorld', PASSWORD_DEFAULT, ['cost' => 10]), true],
        ];
        foreach ($testCases as $testCase) {
