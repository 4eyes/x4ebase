...
class CheckboxViewHelperTest extends \X4e\X4ebase\Tests\Unit\Base\ViewHelperTestBase
{
    ...
    public function testRenderHiddenFieldsForEmptyValue()
    {
        ...
        $this->viewHelperVariableContainer = $this->getMock(\TYPO3\CMS\Fluid\Core\ViewHelper\ViewHelperVariableContainer::class, array("exists", "get", "addOrUpdate"), array(), "", true);
