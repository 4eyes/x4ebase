 ...
 */
class EmailLogRepositoryTest extends \X4E\X4ebase\Tests\Unit\Domain\Repository\RepositoryTestAbstractClass {
    /**
     * @test
     */
    public function canBeInstantiated() {
        $this->subject = new \X4E\X4ebase\Domain\Repository\EmailLogRepository($this->objectManager);
        parent::canBeInstantiated();
    }
}
