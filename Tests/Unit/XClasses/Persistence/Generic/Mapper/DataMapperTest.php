...
class DataMapperTest extends \X4e\X4ebase\Tests\Unit\Base\TestCaseBase
{
    ...
    public function testThawProperties()
    {
        ...
        $dataMap = $this->getMock(\TYPO3\CMS\Extbase\Persistence\Generic\Mapper\DataMap::class, ['getLanguageIdColumnName'], [], '', false);
        ...
        $object = $this->getMock(\TYPO3\CMS\Belog\Domain\Model\LogEntry::class, ['_setProperty', '_getProperties']);
        $object->expects($this->once())->method('_getProperties')->willReturn([]);
